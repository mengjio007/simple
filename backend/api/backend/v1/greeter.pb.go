...
// 	protoc        v3.19.3
// source: backend/v1/greeter.proto
...
var file_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: backend.v1.HelloRequest
	(*HelloReply)(nil),   // 1: backend.v1.HelloReply
}
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	0, // 0: backend.v1.Greeter.SayHello:input_type -> backend.v1.HelloRequest
	1, // 1: backend.v1.Greeter.SayHello:output_type -> backend.v1.HelloReply
